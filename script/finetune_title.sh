...
for task_tag in _mlm _mlm_mim
do
    name=finetune_title${task_tag}${tokenizer_tag}_lr${learning_rate}_bs_${batch_size}
    ...
    --max_epochs 40 \
    --pretrained /nlp_group/wuxing/yuhuimu/AB-layoutlmv3/output/pretrain${task_tag}_lr1e-5_bs_5/epoch_19/checkpoint.pth > logs/${name}_${1}.log 2>&1
    wait
done
