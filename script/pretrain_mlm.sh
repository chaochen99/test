...
tokenizer_tag=
data_tag=_ori
name=pretrain_mlm${tokenizer_tag}_lr${learning_rate}_bs_${batch_size}
sleep 3h
...
--max_epochs 20 \
--model_params /nlp_group/wuxing/yuhuimu/AB-layoutlmv3/output/pretrain_mlm_lr1e-5_bs_5/epoch_17/checkpoint.pth \
