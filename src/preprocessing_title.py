...
import torch
from transformers import LayoutLMv3FeatureExtractor, LayoutLMv3Tokenizer, XLMRobertaTokenizer
...
def main(args):
    ...
    for iter in range(0, len(ori_data), args.split_size):
        ...
        with open(f"{args.output_dir}{args.output_filename}/title.pkl", 'wb') as f:
