...
from model.LayoutLMv3forTitle_img import LayoutLMv3ForTitle as LayoutLMv3ForPretraining
    ...
    def validation():
        ...
        with torch.no_grad():
            ...
            for batch in val_metric_logger.log_every(valid_dataloader, val_print_freq, val_header):
                ...
                inputs = {k: batch[k].to(f"cuda:{model.device_ids[0]}") for k in ["pixel_values"]}
